...
export default function StakingStickyMenu() {
    ...
    <StickyHelper>
       <Card className={classes.cards} elevation={2}>
          ...
          <Box className={classes.container}>
            ...
            <Typography className={classes.text}>
            For Tiers 4 and 5 ONLY: 180 day & 365 day Stakers get a portion of their rewards up front. 
            </Typography>
            <Typography className={classes.text}>
        ...
        <Card className={classes.cards} elevation={2}>
          ...
          <Box className={classes.container}>
            <Typography className={classes.text}>
            You can only have ONE active staking contract per wallet, once your staking contract has ended you will be eligible to withdraw or Re-Stake.
            </Typography>
            <Typography className={classes.text}>
