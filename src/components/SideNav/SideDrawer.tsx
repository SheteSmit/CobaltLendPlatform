      ...
      { drawerOpen && (
        <Box className={classes.iconBoxContainer}>
          <Box className={classes.socialContianer}>
            <Link href="https://t.me/cobaltlend" target="_blank" rel="noopener" className={classes.iconContianer}>
            <img src={telegram} className={classes.socialIcons}/>
            </Link>
            <Link href="https://github.com/cobaltlend" target="_blank" rel="noopener" className={classes.iconContianer}>
            <img src={github} className={classes.socialIcons}/>
            </Link>
            <Link href="https://www.reddit.com/user/cobaltlend" target="_blank" rel="noopener" className={classes.iconContianer}>
            <img src={reddit} className={classes.socialIcons}/>
              </Link>
            <Link href="https://twitter.com/CobaltLend" target="_blank" rel="noopener"className={classes.iconContianer}>
            <img src={twitter} className={classes.socialIcons}/>
            </Link>
          </Box>
          <Box className={classes.socialContianer}>
            <Link href="https://cobaltlend.com" target="_blank" rel="noopener" className={classes.iconContianer}>
              <img src={Cobalt} className={classes.socialIcons}/>
            </Link>
            <Link href="https://cobaltlend.medium.com/" target="_blank" rel="noopener" className={classes.iconContianer}>
            <img src={medium} className={classes.socialIcons}/>
            </Link>
            <Link href="https://www.reddit.com/user/cobaltlend" target="_blank" rel="noopener" className={classes.iconContianer}>
            <img src={whitepaper} className={classes.socialIcons}/>
              </Link>
            <Link href="https://www.youtube.com/channel/UCKM6Q-FEcmHk9zb0sPy8xpA" target="_blank" rel="noopener"className={classes.iconContianer}>
